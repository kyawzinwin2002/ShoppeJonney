...
import { AiFillMinusSquare, AiFillPlusSquare, AiFillStar } from "react-icons/ai";
...
const CartChild = (props) => {
  ...
  const { id, title, image, description, price,quantity,rating } = props;
      ...
      <div className=" flex gap-3 items-start">
        ...
        <div className=" flex flex-col gap-2">
          <div className=" flex items-center justify-between">
            <h1 className=" text-2xl text-gray-500 font-semibold dark:text-violet-500">
          ...
          <div className=" flex items-center justify-between">
            <p className=" text-base text-gray-800 font-bold dark:text-white">${realPrice}</p>
